    ...
    <div class="col-12">
        <form>
            ...
            <div class="form-row d-xl-flex justify-content-center align-items-center justify-content-xl-center" style="margin-bottom: 20px;">
                <div class="col-12 col-lg-6 d-flex d-xl-flex justify-content-center align-items-center justify-content-xl-center" style="padding: 0px;"><input type="text" class="form-control" placeholder="Nama Usaha" required /></div>
            </div>
            <div class="form-row d-xl-flex justify-content-center align-items-center justify-content-xl-center" style="margin-bottom: 20px;">
                <div class="col-12 col-lg-6 d-flex d-xl-flex justify-content-center align-items-center justify-content-xl-center" style="padding: 0px;"><textarea class="border rounded form-control" placeholder="Deskripsi Usaha" style="padding: 7px;" required></textarea></div>
            </div>
            ...
            <div class="form-row">
                <div class="col d-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-lg-center justify-content-xl-center align-items-xl-center"><a class="btn btn-primary border rounded" role="button" style="width: 121px;background-color: rgb(255,65,65);" href="pencarian usaha.html">Verifikasi</a></div>
            </div>
        </form>
    </div>
</div>
