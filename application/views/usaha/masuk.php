    ...
    <div class="col-12">
        ...
        <form method="post" action="Login/loginUser">
            ...
            <div class="form-row d-xl-flex justify-content-center align-items-center justify-content-xl-center" style="margin-bottom: 20px;">
                ...
                <div class="col-12 col-lg-6 d-flex d-xl-flex justify-content-center align-items-center justify-content-xl-center" style="padding: 0px;"><input class="border rounded form-control" type="email" placeholder="Email" name="email" style="padding: 7px;"></div>
            </div>
