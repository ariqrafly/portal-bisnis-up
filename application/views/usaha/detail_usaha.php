...
<div class="row" style="padding: 32px;padding-top: 0px;padding-bottom: 0px;margin:0px;margin-bottom: 62px;">
    ...
    <div class="col-12 col-md-6">
        ...
        <input class="border rounded-0" value="<?= $usaha['instagram'];?>" name="instagram" style="width: 100%;">
        ...
        <input class="border rounded-0" value="<?= $usaha['whatsapp'];?>" name="whatsapp" style="width: 100%;">
